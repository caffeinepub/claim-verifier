import { c as createLucideIcon, j as jsxRuntimeExports, a as cn, u as useEvidenceVoteTally, b as useSessionVoteForEvidence, d as useVoteEvidence, r as reactExports, C as ChevronUp, e as ChevronDown, f as useSessionGate, g as ue, h as ChartNoAxesColumn, S as Swords, T as TrendingDown, i as TrendingUp, k as CircleX, l as CircleCheck, m as useUsername, n as useVerifiedAccount, o as useReportReply, p as useReplies, q as useReplyLikeCounts, A as AnimatePresence, s as motion, L as LoaderCircle, t as useAddReply, v as useAddReputationEvent, w as Textarea, I as ImageUploader, x as Link2, U as UrlInputList, y as Clock, B as Button, z as useProfileByUsername, D as useLikeReply, E as useAccountPermissions, F as useSessionLikeForReply, G as UserProfileCard, H as isVerifiedUsername, J as UserAvatar, K as isTrustedContributorSession, V as VerifiedBadge, M as formatRelativeTime, N as Check, O as DropdownMenu, P as DropdownMenuTrigger, Q as Ellipsis, R as DropdownMenuContent, W as DropdownMenuItem, X as Share2, Y as Flag, Z as ReportDialog, _ as X, $ as getActivePrincipalId, a0 as appendUserComment, a1 as useTrustedSources, a2 as useClaimById, a3 as useEnhancedVoteTally, a4 as useSessionVote, a5 as useEvidenceForClaim, a6 as useAllEvidenceTallies, a7 as useSubmitVote, a8 as useSubmitEvidence, a9 as useReportContent, aa as useQueryClient, ab as useActor, ac as Skeleton, ad as CategoryBadge, ae as TooltipProvider, af as Tooltip, ag as TooltipTrigger, ah as Flame, ai as TooltipContent, aj as getVerifiedVoteForClaim, ak as computeOverallVerdict, al as VerdictBar, am as Search, an as Input, ao as DropdownMenuLabel, ap as DropdownMenuSeparator, aq as AuthorDisplay, ar as getClaimSlug, as as getOrInitUsername, at as appendUserEvidence } from "./index-D_FhFQ6_.js";
import { S as Send, g as getEditRecord, c as canEditContent, s as saveEditRecord, E as EditHistoryModal, C as CornerDownRight, L as Lightbox } from "./Lightbox-bdzWcmYN.js";
import { E as ExternalLink, g as getSourceTypeLabel, a as getSourceTypeBonus, b as getSourceTypeBadgeClasses, c as computeSourceCredibility, d as computeFlatSourceBoost } from "./TrustedSourcesPage-XLlbd838.js";
import { M as MessageSquare, S as ShieldCheck } from "./shield-check-Cn1czz98.js";
import { P as Pencil } from "./pencil-BQHY1cS5.js";
import { A as ArrowLeft } from "./arrow-left-BvteElEl.js";
import "./shield-CfzopQoY.js";
/**
...
function ReplyImageGrid({ imageUrls }) {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Button,
          {
            ...
            disabled: addReply.isPending || cooldownLeft > 0 || isImageUploading || !text.trim(),
...
function ReplyCard({
  ...
  const [isEditingReply, setIsEditingReply] = reactExports.useState(false);
  const [replyEditText, setReplyEditText] = reactExports.useState("");
  const [replyEditHistoryOpen, setReplyEditHistoryOpen] = reactExports.useState(false);
  const replyEditRecord = principalId ? getEditRecord("reply", reply.id.toString(), principalId) : null;
  const showReplyEdit = !!principalId && canEditContent(
    "reply",
    reply.timestamp,
    reply.sessionId,
    sessionId,
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "group py-2", children: [
          ...
          isEditingReply ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-2 space-y-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Textarea,
              {
                value: replyEditText,
                ...
                "button",
                {
                  ...
                  onClick: () => {
                    ...
                    saveEditRecord(
                      ...
                      principalId,
                      replyEditText.trim(),
                      (replyEditRecord == null ? void 0 : replyEditRecord.currentText) ?? displayText,
                      0
                    );
                    setIsEditingReply(false);
                    ue.success("Reply updated");
                  },
          ...
          ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-2 group/replytext", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-foreground font-body leading-relaxed inline", children: (replyEditRecord == null ? void 0 : replyEditRecord.currentText) ?? displayText }),
            replyEditRecord && /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
            ...
            showReplyEdit && /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
                onClick: () => {
                  setReplyEditText((replyEditRecord == null ? void 0 : replyEditRecord.currentText) ?? displayText);
          ...
          attachedImages.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(ReplyImageGrid, { imageUrls: attachedImages }),
          attachedUrls.filter(Boolean).length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(UrlChips$1, { urls: attachedUrls }),
          replyEditRecord && /* @__PURE__ */ jsxRuntimeExports.jsx(
            EditHistoryModal,
            {
...
function EvidenceTextDisplay({
  ...
  const record = principalId ? getEditRecord("evidence", item.id.toString(), principalId) : null;
  const initialText = (record == null ? void 0 : record.currentText) ?? item.text;
  const [isEditing, setIsEditing] = reactExports.useState(false);
  const [editText, setEditText] = reactExports.useState(initialText);
  const [displayText, setDisplayText] = reactExports.useState(initialText);
  const [editRecord, setEditRecord] = reactExports.useState(record);
  const [historyOpen, setHistoryOpen] = reactExports.useState(false);
  const showEdit = !!principalId && canEditContent(
    "evidence",
    item.timestamp,
    item.sessionId,
    sessionId,
  ...
  const wasEditedAfterVotes = (editRecord == null ? void 0 : editRecord.wasEditedAfterVotes) ?? false;
  function handleSave() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-1 group/text", children: [
    ...
    wasEditedAfterVotes && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-amber-600 dark:text-amber-400 font-body italic mb-1", children: "⚠️ Edited after receiving votes" }),
    editRecord && /* @__PURE__ */ jsxRuntimeExports.jsx(
      EditHistoryModal,
      {
        open: historyOpen,
...
function ClaimEditForm({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2 mb-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "input",
      {
        type: "text",
...
function ClaimDetail({
  ...
  const [reportDialogOpen, setReportDialogOpen] = reactExports.useState(false);
  const [claimEditOpen, setClaimEditOpen] = reactExports.useState(false);
  const [claimEditHistoryOpen, setClaimEditHistoryOpen] = reactExports.useState(false);
      ...
      children: [
        ...
        claimLoading ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { children: [
            ...
            (() => {
              const pid = (verifiedPrincipal == null ? void 0 : verifiedPrincipal.toString()) ?? null;
              const titleRecord = pid ? getEditRecord("claim", `${claim.id}_title`, pid) : null;
              const descRecord = pid ? getEditRecord("claim", `${claim.id}_desc`, pid) : null;
              const editedTitle = (titleRecord == null ? void 0 : titleRecord.currentText) ?? claim.title;
              const editedDesc = (descRecord == null ? void 0 : descRecord.currentText) ?? claim.description;
              const showClaimEdit = pid && canEditContent(
                "claim",
                claim.timestamp,
                claim.sessionId ?? "",
                sessionId,
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                claimEditOpen && pid ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  ClaimEditForm,
                  {
                    ...
                    onSave: (t, d) => {
                      ...
                      ue.success("Claim updated");
                    },
                    onCancel: () => setClaimEditOpen(false)
                  }
                ) }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-2 group/claimtitle", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-display text-3xl font-bold leading-tight text-foreground flex-1", children: [
                      editedTitle,
                    ...
                    showClaimEdit && /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "button",
                      {
                        type: "button",
                  ...
                  anyRecord && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mt-1 flex-wrap", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "button",
                      {
                        type: "button",
                    ...
                    anyRecord.wasEditedAfterVotes && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-amber-600 dark:text-amber-400 font-body italic", children: "⚠️ This claim was edited after voting began" })
                  ] }),
                  anyRecord && /* @__PURE__ */ jsxRuntimeExports.jsx(
                    EditHistoryModal,
                    {
                      open: claimEditHistoryOpen,
                      onClose: () => setClaimEditHistoryOpen(false),
                      history: (titleRecord == null ? void 0 : titleRecord.editHistory) ?? (descRecord == null ? void 0 : descRecord.editHistory) ?? [],
                      currentText: editedTitle,
                      currentEditedAt: anyRecord.lastEditedAt
                    }
                  )
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-base text-muted-foreground leading-relaxed", children: editedDesc })
              ] });
            })(),
