import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, aM as Primitive, a as cn, bi as Globe, _ as useTrustedSources, a$ as useAllEvidenceForAllClaims, a3 as useAllEvidenceTallies, m as motion, ak as Search, al as Input, a8 as Skeleton, A as AnimatePresence, i as ChartNoAxesColumn } from "./index-BtF6ZgDC.js";
    ...
    motion.div,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3 mb-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 min-w-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 flex-wrap mb-1", children: [
        ...
        credibility.status === "insufficient" ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[10px] font-body text-muted-foreground mt-1", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-body text-muted-foreground", children: "Credibility" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-lg font-bold font-mono text-foreground leading-tight", children: [
                Math.round(credibility.score),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-body text-muted-foreground font-normal", children: "/100" })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-body text-muted-foreground", children: "Citations" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg font-bold font-mono text-foreground leading-tight", children: credibility.totalCitations })
            ] })
          ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[10px] font-body text-muted-foreground", children: [
            "Cited in ",
    ...
    motion.div,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground font-body ml-3", children: "Sources are automatically indexed when cited in claims or evidence. Credibility scores are calculated from how well evidence citing each source performs in the community." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3 p-3 mb-6 bg-secondary border border-border rounded-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Info, { className: "h-4 w-4 text-primary flex-shrink-0 mt-0.5" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs font-body text-muted-foreground leading-relaxed", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-foreground", children: "How credibility is calculated:" }),
            " ",
            "Only evidence with a community net score of +3 or higher counts toward a source's credibility. Scores are normalized so that average quality and pass rate are weighted equally. A source needs at least 5 citations before receiving a score."
          ] })
        ] }),
