import { c as createLucideIcon, r as reactExports, o as useUsername, p as useVerifiedAccount, aV as useReportSourceComment, aW as useSourceComments, aX as useSourceCommentLikeCounts, j as jsxRuntimeExports, a8 as Skeleton, m as motion, aY as useAddSourceComment, x as Textarea, ai as ImageUploader, L as LoaderCircle, ar as Link2, aj as UrlInputList, y as Clock, B as Button, f as useSessionGate, g as ue, z as useProfileByUsername, aZ as useLikeSourceComment, E as useAccountPermissions, a_ as useSessionLikeForSourceComment, a as cn, U as UserProfileCard, G as isVerifiedUsername, H as UserAvatar, J as formatRelativeTime, C as ChevronUp, K as DropdownMenu, M as DropdownMenuTrigger, N as Ellipsis, O as DropdownMenuContent, P as DropdownMenuItem, Q as Share2, R as Flag, A as AnimatePresence, X, _ as useTrustedSources, a$ as useAllEvidenceForAllClaims, a3 as useAllEvidenceTallies, b0 as useWikipediaBlurb, aa as TooltipProvider, b1 as BookOpen, a7 as useActor, b2 as useQuery, ay as useAllClaims, b3 as useQueries, i as ChartNoAxesColumn, b4 as useAdminOverrideSource, b5 as useAdminRemoveSource, b6 as useAdminSetPinnedComment, b7 as getDispute, b8 as getDisputeVote, b9 as Select, ba as SelectTrigger, bb as SelectValue, bc as SelectContent, bd as SelectItem, a0 as useEnhancedVoteTally, ag as computeOverallVerdict, be as saveDispute, bf as clearDispute, bg as saveDisputeVote } from "./index-3LlU-o4g.js";
import { M as MessageSquare, S as ShieldCheck } from "./shield-check-DZnIj2XZ.js";
import { S as Send, C as CornerDownRight } from "./send-B02LDT2U.js";
import { c as computeSourceCredibility, S as SourceLogo, E as ExternalLink, g as getSourceTypeLabel, b as getSourceTypeBadgeClasses } from "./TrustedSourcesPage-Cwcl7CUf.js";
import { A as ArrowLeft } from "./arrow-left--cQ4E0JB.js";
import { S as Shield } from "./shield-t2ZB3Ns-.js";
import { P as Pencil } from "./pencil-CGZBoC-J.js";
import { V as Vote } from "./vote-DEbHIbIF.js";
/**
...
function CommentForm({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "space-y-2", children: [
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "group py-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-foreground font-body leading-relaxed mb-2", children: displayText }),
          attachedImages.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1.5 mb-2", children: attachedImages.map((url) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
              src: url,
              alt: "Attachment",
          ...
          attachedUrls.filter(Boolean).length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-0.5 mb-2", children: attachedUrls.filter(Boolean).map((url) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "a",
            {
              href: url,
              target: "_blank",
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Link2, { className: "h-2.5 w-2.5 flex-shrink-0" }),
                url
              ]
            },
            url
...
function EvidencePerformanceSection({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-3", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-lg font-bold text-foreground", children: "Evidence Performance" })
    ] }),
    credibility.status === "insufficient" ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 bg-card border border-border rounded-sm space-y-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm font-body text-muted-foreground", children: [
        ...
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-foreground", children: "5 citations" }),
        " ",
      ...
      children: [
        ...
        isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-ocid": "source_detail.loading_state", className: "space-y-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: cn(
                ...
                credibility.status === "scored" && credibility.label === "High Credibility" ? "border-l-green-500 border-emerald-500/30 shadow-sm shadow-emerald-500/5" : credibility.status === "scored" && credibility.label === "Low Credibility" ? "border-l-red-500 border-red-400/30" : "border-l-amber-400 border-border"
              ),
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-6 mb-4 pt-3 border-t border-border", children: credibility.status === "scored" ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                ...
                ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm font-body text-muted-foreground italic", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "space-y-4", children: [
            wikiLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-16 w-full rounded-sm" }) : displayedBlurb ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-2 mb-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-1 h-5 bg-primary rounded-full" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-base font-semibold text-foreground", children: "About" })
                ] }),
                canEditBlurb && !wikiBlurb && !editingBlurb && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  Button,
                  {
                    variant: "ghost",
                    size: "sm",
            ...
            ] }) : canEditBlurb ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-1 h-5 bg-primary rounded-full" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-base font-semibold text-foreground", children: "Evidence Performance" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(EvidencePerformanceSection, { credibility })
            ] })
          ] }),
